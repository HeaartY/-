import { loadGuangdongMapData, loadCityMapData } from './map-data-appeal-map.js';
import { MapInteractionsAppealMap } from './map-interactions-appeal-map.js';
...
export class TwinMapSceneAppealMap {
  ...
  async start() {
    ...
    this.buildScene();
    this.interactions = new MapInteractionsAppealMap({
      camera: this.camera,
