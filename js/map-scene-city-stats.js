import { loadGuangdongMapData } from './map-data-city-stats.js';
import { MapInteractionsCityStats } from './map-interactions-city-stats.js';
...
export class TwinMapSceneCityStats {
  ...
  async start() {
    ...
    this.buildScene();
    this.interactions = new MapInteractionsCityStats({
      camera: this.camera,
